    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if day_offset == 0:
                ...
                return f"{city} の現在の天気は {weather_description} で、気温は {temperature_celsius:.1f}°C です。"
            else:
                # 今日の日付を取得
                ...
                if not target_forecasts:
                    return f"申し訳ありませんが、{city} の {target_date} の天気情報は見つかりませんでした。"
                ...
                return f"{city} の {target_date} の天気は '{most_common_weather}' と予想されています。"
        else:
            # API のリクエストが失敗した場合
            return "地球に住んでいるのか確認してみてください。"
    except Exception as e:
        # 何らかのエラーが発生した場合
        return "天気データの取得中にエラーが発生しました。"
